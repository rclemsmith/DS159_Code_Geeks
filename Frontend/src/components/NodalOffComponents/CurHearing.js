      ...
      <div style={{backgroundColor:'rgb(240,240,240)',overflow:'hidden'}}>
        ...
        <div className="ch1">
            <div className="ch16">
              ...
              <i className="ic" onClick={this.hearingUpdate} className="fa fa-cloud-upload ch20"></i>
            </div>
            <div className="ch3">
              <span className="ch4">Judge :</span>
              <span className="curjudge">{this.props.location.state.curjudge}</span>
            </div>
            <div className="ch3">
              <span className="ch7">Lawyer :</span>
              <span className="curlawyer">{this.props.location.state.curlawyer}</span>
            </div>
            <div className="ch9">
            ...
            <div style={{marginLeft:'0.1vh', marginBottom:'5vh'}} className="row">
                  ...
                  <tbody>
                    {curhear.map((id) => {
                      return (
                        <tr>
                          <td>{(count += 1)}</td>
                          <td style={{textTransform:'capitalize'}}>{id.name}</td>
                          <td>{id.age}</td>
                          <td style={{textTransform:'capitalize',textAlign:'justify'}}>{id.comments}</td>
                          <td>{id.phone}</td>
                          <td style={{textTransform:'capitalize'}}>{id.district}</td>
                          <td style={{textTransform:'capitalize'}}>{id.state}</td>
                          <td>{id.pincode}</td>
                        </tr>
                      );
                    })}
